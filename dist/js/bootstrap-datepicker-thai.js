    ...
    $.extend(DatePicker.prototype, {
      fillThai: function () {
        ...
        this.picker
          ...
          .find("th:eq(2)")
          .text(
            parseInt(d.getUTCFullYear() / 10, 10) * 10 +
              543 +
              "-" +
              ((parseInt(d.getUTCFullYear() / 10, 10) + 1) * 10 - 1 + 543)
          )
          .end()
          .find("td")
          .find("span.year")
        ...
        this.picker
          ...
          .find("th:eq(2)")
          .text(
            parseInt(d.getUTCFullYear() / 100, 10) * 100 +
              543 +
              "-" +
              ((parseInt(d.getUTCFullYear() / 100, 10) + 1) * 100 - 10 + 543)
          )
          .end()
          .find("td")
          .find("span.decade")
        ...
        this.picker
          ...
          .find("th:eq(2)")
          .text(
            parseInt(d.getUTCFullYear() / 1000, 10) * 1000 +
              543 +
              "-" +
              ((parseInt(d.getUTCFullYear() / 1000, 10) + 1) * 1000 - 100 + 543)
          )
          .end()
          .find("td")
          .find("span.century")
      ...
      hide: function (e) {
        ...
        if (this.picker.is(":visible")) _basemethod_.hide.call(this, e);
