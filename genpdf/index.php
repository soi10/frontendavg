...
<table>
  ...
  <tr>
    ...
    พบช.ตรวจสอบหน่วย ได้ดำเนินการเฉลี่ยหน่วยโดยใช้วิธีเฉลี่ยหน่วยจาก '.$data[0]['in_cause'].'   ในรอบบิล '.$data[0]['billing_Cycle'].' '.convertYear($data[0]['year']).' แล้วจำนวน '.$data[0]['sum_to_sap_final'].' หน่วย จึงขอรายงานผลการดำเนินการ โดยมีรายละเอียดตามเอกสารแนบ จำนวน ......... ฉบับ </td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  </tr>
